    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == code){
            if (resultCode == RESULT_OK) {
                ...
                listItems.add(data.getStringExtra("Hour")+":");
                listItems.add(data.getStringExtra("Minute"));
                Log.d("Hour", data.getStringExtra("Hour"));
//                listItems.add(data.getStringExtra("Month")+"-");
//                listItems.add(data.getStringExtra("Day")+"-");
//                listItems.add(data.getStringExtra("Year"));
                writeItems();
            }
        }
